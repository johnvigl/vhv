...
import { renderHighlightLayer, updateHandler } from './collaboration/collab-extension.js';
...
comments.observe(event => {
  console.log('Comments array changed', event);
  renderComments(comments);
  // let highlights = comments.toArray()?.filter((c) => c?.highlight != null);
...
window.example = { yProvider, ydoc, type, comments };
